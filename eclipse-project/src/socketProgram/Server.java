            ...
            try {
	            ...
	            if(!packet.isEmpty()) {
	            	...
	            	System.out.println("Method:" + requestPath.get(0)+  " FilePath: " + requestPath.get(1) + " FileName:" + requestPath.get(2));
	         	      //CHeck one more time if there is a file.txt format in fileName
	            	String fileName = requestPath.get(2);
	            	boolean canContinue = fileName.contains(".");
	            	if(canContinue) {
	            		...
	            		out.println("HTTP/1.1 200 OK\r\n\r\n");
	            		out.println("Path: " + requestPath.get(1) + " is Invalid.");
